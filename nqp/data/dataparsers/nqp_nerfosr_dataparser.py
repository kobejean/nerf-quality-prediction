...
@dataclass
class NQPNeRFOSRDataParserConfig(DataParserConfig):
    """Nerfstudio dataset config"""

    _target: Type = field(default_factory=lambda: NQPNeRFOSRDataParser)
...
@dataclass
class NQPNeRFOSRDataParser(DataParser):
    """NeRFOSR Dataparser
    Presented in the paper: https://4dqv.mpi-inf.mpg.de/NeRF-OSR/
    ...
    config: NQPNeRFOSRDataParserConfig
